...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("src\\coordinate_systems.vs", "src\\coordinate_systems.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // view2 = glm::translate(view2, glm::vec3(-1.0f, 0.0f, 0.0f));
        // projection2 = glm::perspective(glm::radians(-45.0f), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
        // retrieve the matrix uniform locations
        unsigned int modelLoc = glGetUniformLocation(ourShader.ID, "model");
        unsigned int viewLoc = glGetUniformLocation(ourShader.ID, "view");

        // unsigned int modelLoc2 = glGetUniformLocation(ourShader.ID, "model2");
        // unsigned int viewLoc2 = glGetUniformLocation(ourShader.ID, "view2");
        ...
        // ourShader.setMat4("projection2", projection2);
