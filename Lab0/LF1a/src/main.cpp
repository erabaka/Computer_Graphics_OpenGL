...
int main()
{
    ...
    unsigned int fragmentShaderRed = glCreateShader(GL_FRAGMENT_SHADER); // the first fragment shader that outputs the color orange
    unsigned int fragmentShaderGreen = glCreateShader(GL_FRAGMENT_SHADER); 
    unsigned int fragmentShaderWhite = glCreateShader(GL_FRAGMENT_SHADER);// the second fragment shader that outputs the color yellow

    unsigned int shaderProgramRed = glCreateProgram();
    unsigned int shaderProgramGreen = glCreateProgram();
    unsigned int shaderProgramWhite = glCreateProgram(); // the second shader program
